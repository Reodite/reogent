    ...
    >
      {terms.map((term, index) => (
        <button
          ...
          className={`focus-visible:ring-primary/40 min-h-11 shrink-0 rounded-sm px-3 text-xs font-medium transition-colors focus-visible:ring-2 focus-visible:ring-offset-1 sm:min-h-8 ${
            term.key === selected
