...
const BUTTON_VARIANT_CLASSES = {
  ...
  ghost:
    "text-on-surface-variant enabled:hover:bg-surface-container-high enabled:hover:text-on-surface enabled:active:bg-surface-container",
  outline:
...
const SIZE_CLASSES = {
  ...
  default: "h-11 rounded-lg px-4 text-sm sm:h-9",
  prominent: "h-11 rounded-lg px-4 text-sm sm:h-10",
  field: "h-11 rounded-lg px-4 text-sm",
  large: "h-12 rounded-xl px-8 text-base",
  icon: "size-11 rounded-lg p-0 sm:size-9",
