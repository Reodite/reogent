  ...
  return (
    <aside ref={ref} data-sources-panel className="mt-2">
      <details onToggle={handleToggle}>
        <summary className="hover:bg-surface-container/60 inline-flex min-h-[44px] cursor-pointer list-none items-center gap-1.5 rounded-lg px-3 py-2 text-xs font-medium select-none [&::-webkit-details-marker]:hidden">
